...
export function DeclarationGenerator({ company, proposal, initialType = "unificada" }: DeclarationGeneratorProps) {
  ...
  const buildDeclarationText = (type: string, city: string, dateStr: string) => {
    ...
    repName = repName || "Dalton Abdon B. Pereira";
            ...
            <div>
              ...
              <div className="border-b-2 border-slate-900 pb-4 mb-6 text-center">
                <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wide">
                  {company.razaoSocial || "INFOR TECH SOLUCOES (DALTON A. B. PEREIRA)"}
                </h2>
                <p className="text-xs font-semibold text-slate-600">CNPJ: {company.cnpj || "39.335.069/0001-01"}</p>
